...
                finalLink: item.link // TAMBAHKAN properti unik baru
            };
        });
...
            ep.url = `/episodes/${ep.uniqueSlug}/`; // Biarkan properti url di-override oleh Eleventy
            // ep.finalLink sudah diset di tahap map
        }
